...
public class modern_imu : MonoBehaviour
{
    /// <summary>
    ...
    imu imuComponent;           // Reference to the imu component
    ...
    void FixedUpdate()
    {
        ...
        imuComponent.acceleration = new Vector3(
            localAcceleration.z,    // X ← Z
            -localAcceleration.x,   // Y ← -X
            -localAcceleration.y     // Z ← -Y
        );
        imuComponent.gyro = new Vector3(
            localAngularVelocity.z,    // X ← Z
            -localAngularVelocity.x,   // Y ← -X
            -localAngularVelocity.y     // Z ← -Y
        );
    }
}
